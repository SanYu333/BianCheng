...
public class GenEntityMysql {
    ...
    private static final String URL = "jdbc:mysql://localhost:3306/myschool?serverTimezone=UTC&characterEncoding=utf8&useUnicode=true&useSSL=false";
    private static final String NAME = "root";
    private static final String PASS = "root";
    private static final String DRIVER = "com.mysql.jdbc.Driver";
    private String packageOutPath = "com.zss.pojo";// 指定实体生成所在包的路径
    private String authorName = "mj";// 作者名字
